...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/myvpn1/izin/main/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/myvpn1/izin/main/ip | grep $MYIP | awk '{print $2}')
Isadmin=$(curl -sS https://raw.githubusercontent.com/myvpn1/izin/main/ip | grep $MYIP | awk '{print $5}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/myvpn1/izin/main/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/myvpn1/izin/main/ip | grep $MYIP | awk '{print $3}')
fi
...
echo -e "└──────────────────────────────────────────┘" | lolcat
echo -e "\033[1;96m  Type Script  : Multiport V5 \e[0m"
